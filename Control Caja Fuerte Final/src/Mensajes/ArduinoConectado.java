 ...
 * @author IGINO
 */
public class ArduinoConectado extends javax.swing.JFrame {

    /**
     * Creates new form Cargando
     */
    public ArduinoConectado() {
        int i = 0;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Arduino Conectado con exito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArduinoConectado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArduinoConectado().setVisible(true);
            }
        });
    }
